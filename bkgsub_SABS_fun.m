function bkgsub_SABS_fun (window,withIllumCorrection)
...
nLearningFrame = 400;
thresholdBhatt = .8;
%radiusRegion = 0;%window = 4;%withIllumCorrection =true;
windowILLSize = 390;
withIllumCorrectionO = withIllumCorrection;
if withIllumCorrection == 0
...
for curRadius = [0,6]
    ...
    if withIllumCorrectionO ~= 0
        ...
        paramString2 = ['_new_NoSm',int2str(binRatio),'_0_',num2str(thresholdBhatt),'_',num2str(window),'_',num2str(threshOffsetIll),'_',num2str(windowILLSize),'_SABS'];
    else
        paramString = ['_new_NoSm',int2str(binRatio),'_',int2str(radiusRegion),'_',num2str(thresholdBhatt),'_',num2str(window),'_SABS'];
        paramString2 = ['_new_NoSm',int2str(binRatio),'_0_',num2str(thresholdBhatt),'_',num2str(window),'_SABS'];
    end
    if(notSaveGT == false)
        imgBaseNameTest = '/home/andrea/Scrivania/SABS/Test/MPEG4_40kbps/MPEG4_';
    else
        imgBaseNameTest = ['./results',paramString2,'/origvideo/images/frame0'];
    end
